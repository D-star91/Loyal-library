                    ...
                    <div class="lb-menu">
                        ...
                        <div class="collapse mt-3 mb-3" id="collapseExample">
                            <ul>
                                ...
                                <li><a class="botn botn-menu" href="">သင်ခန်းစာ</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="lb-pagination">
                        <nav aria-label="...">
                            <ul class="pagination pagination-circle">
                                <li class="page-item">
                                <a class="page-link" href="{{route('free_books')}}" tabindex="-1" aria-disabled="true">First page</a>
                                </li>
                                <li class="page-item "><a class="page-link" href="{{route('free_books')}}">1</a></li>
